...
> Official Stagehand SDK for Java
...
To set a documented parameter or property to an undocumented or not yet supported *value*, pass a [`JsonValue`](https://github.com/browserbase/stagehand-java/blob/main/stagehand-java-core/src/main/kotlin/com/browserbase/api/core/Values.kt) object to its setter:
